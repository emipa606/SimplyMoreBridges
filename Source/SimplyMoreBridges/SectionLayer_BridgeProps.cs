		...
		private bool ShouldDrawPropsBelow(IntVec3 c, TerrainGrid terrGrid)
		{
			...
			else
			{
				...
				else
				{
					...
					result = !IsTerrainThisBridge(terrain) && (c2.SupportsStructureType(Map, TerrainAffordanceDefOf.Bridgeable) || c2.SupportsStructureType(Map, TerrainAffordanceDefOf.BridgeableDeep));
				}
			}
			return result;
		}
