...
internal class SimplyMoreBridgesMod : Mod
{
    ...
    public override void DoSettingsWindowContents(Rect rect)
    {
        ...
        listingStandard.Label("SimplyMoreBridges.RestartInfo".Translate());
        listingStandard.Gap();
        ...
        Settings.CostPercent = listingStandard.Slider(Settings.CostPercent, 0.01f, 2f);
        ...
        listingStandard.Gap();
        listingStandard.Label("SimplyMoreBridges.SteelPercent".Translate(Settings.SteelPercent.ToStringPercent("F0"),
            stoneBridge[0].count, stoneBridge[1].count, metalBridge[0].count, metalBridge[1].count));
        Settings.SteelPercent = listingStandard.Slider(Settings.SteelPercent, 0.05f, 0.95f);

        listingStandard.Gap();
        listingStandard.Label("SimplyMoreBridges.SteelPercentDeep".Translate(
        ...
        Settings.SteelPercentDeep = listingStandard.Slider(Settings.SteelPercentDeep, 0.03f, 0.97f);

        if (currentVersion != null)
        {
            listingStandard.Gap();
            GUI.contentColor = Color.gray;
            listingStandard.Label("SimplyMoreBridges.CurrentModVersion".Translate(currentVersion));
